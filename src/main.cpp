...
int main(int argc, char* argv[])
{
    ...
    int n = 20499; //Number of vertices
    int num_edges = 20000; //Number of edges
    ...
    //Print results
    float tot_num_ops_est = 5 * n + 3 * num_edges + 5 * n * log(n) / log(2);
    ...
    std::cout << "estimated number of operations 5V + 3E + 5VlgV: " << tot_num_ops_est << std::endl;
